...
pkill trayer; trayer --edge top --align right --SetDockType true --expand true --width 10 --transparent true --alpha 0 --tint 0x000000 --height 32 --monitor primary --distancefrom right --distance 350
